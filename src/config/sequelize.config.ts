import { Address, CartItemComboOption, CartItemComboOptionIngredient, CartItems, CartItemsIngredient, Carts, Category, Coupons, Ingredient, Order, OrderItemIngredient, OrderItems, Product, ProductIngredient, ProductVariant, Reviews, User, UserCoupons } from "@/models";
...
export const sequelizeConfig = (config: ConfigService) => {
  ...
  return {
    ...
    models: [User, Product, Category, ProductVariant, ProductIngredient, Ingredient, CartItems, Carts, Order, OrderItems, OrderItemIngredient, CartItemsIngredient, Reviews, UserCoupons, Coupons, Address, Combo, ComboItem, CartItemComboOption, CartItemComboOptionIngredient],
  }
}
