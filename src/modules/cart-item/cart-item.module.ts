...
@Module({
  ...
  imports: [SequelizeModule.forFeature([CartItems, Carts, Product, ProductVariant, CartItemsIngredient, ProductIngredient, Ingredient]), ProductModule, ProductVariantModule, CartItemIngredientModule, CartModule],
