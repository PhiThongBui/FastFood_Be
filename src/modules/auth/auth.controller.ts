...
export class AuthController {
  ...
  @ApiOperation({
    ...
    description:
      'Sau khi người dùng đăng nhập Google thành công, Google sẽ gọi lại endpoint này. Hệ thống sẽ tạo hoặc xác thực tài khoản, rồi trả về token + thông tin user.',
  })
  ...
  @ApiOperation({
    summary: 'Quên mật khẩu, Một email được gửi tới với link để người dùng để reset mật khẻu'
  })
  ...
  @ApiBody({
    schema: {
      type: 'object',
      properties: {
        oldPassword: { type: 'string', example: 'OldPass123!', description: 'Mật khẩu hiện tại' },
        newPassword: { type: 'string', example: 'NewPass456!', description: 'Mật khẩu mới (tối thiểu 8 ký tự)' },
        confirmPassword: { type: 'string', example: 'NewPass456!', description: 'Xác nhận mật khẩu mới' },
      },
